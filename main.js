...
//которая может принимать в качестве аргумента любое неотрицательное целое число и возвращать его с цифрами в порядке убывания.
// По сути, переставьте цифры, чтобы получить максимально возможное число.

function descendingOrder(n) {
    // Создаем стрелочную функцию, которая принимает число в качестве аргумента.
    // Преобразуем число в строку (String), затем разбиваем строку на массив символов (['1', '7', '6', '5', '4', '3']).
    // Сортируем символы в порядке возрастания (по юникоду).  ['1', '3', '4', '5', '6', '7']
    // Затем обращаем порядок следования символов с помощью метода reverse. ['7', '6', '5', '4', '3', '1']
    // Наконец, объединяем символы обратно в строку и преобразуем строку в число.
    let sortNumber = (n) => Number([...String(n)].sort().reverse().join(''))

    // Возвращаем результат сортировки в порядке убывания.
    return sortNumber(n)
}

console.log(descendingOrder(176543))
